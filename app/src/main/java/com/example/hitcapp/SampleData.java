...
public class SampleData {
    public static List<Product> getGoldProducts() {
        ...
        // Sử dụng tạm R.drawable.download cho tất cả nếu bạn chưa có đủ ảnh riêng
        // Sau này bạn hãy thay R.drawable.download bằng các ảnh thực tế như R.drawable.nhan, R.drawable.day_chuyen...
